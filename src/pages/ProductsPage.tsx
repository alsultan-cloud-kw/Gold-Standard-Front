...
function ProductCard({
  ...
  const addButtonClass =
    'flex items-center justify-center gap-2 rounded-xl bg-[#0B0F19] px-3 py-2.5 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-[#1F2937] shrink-0'
    ...
    return (
      <div className="flex flex-col gap-4 rounded-2xl border border-black/10 bg-white p-4 transition-shadow hover:shadow-md sm:flex-row sm:items-center">
        <Link to={`/products/${product.slug}`} className="flex min-w-0 flex-1 gap-4">
          <div className="h-28 w-28 shrink-0 overflow-hidden rounded-xl bg-[#F4F4F5] ring-1 ring-black/10 sm:h-32 sm:w-32">
            {imageSrc ? (
  ...
  return (
    <div className="group flex flex-col rounded-2xl border border-black/10 bg-white p-3 transition-shadow hover:shadow-md sm:p-4">
      <Link to={`/products/${product.slug}`} className="block min-w-0 flex-1">
        <div className="relative mb-3 aspect-[4/3] overflow-hidden rounded-xl bg-[#F4F4F5] ring-1 ring-black/10">
          {imageSrc ? (
            <img
              src={imageSrc}
              alt={productName}
